...
public class StepDownload extends Step {
	...
	@Override
	public void doStep() {
			ProcessBuilder n = new ProcessBuilder(ConfigManager.YOUTUBE_DL.getAbsolutePath(), "-o",ConfigManager.TEMP_DIR.getAbsolutePath() + ConfigManager.DS + "%(title)s.%(ext)s",entry.getWebURL());
